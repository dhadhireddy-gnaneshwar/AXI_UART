...
HD_PWD='C:/Users/demon/INTERNSHIP/src_sim_vivado/AXI_UART_V2/AXI_UART_V2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_MASTER_WRAPPER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_MASTER_WRAPPER.tcl
